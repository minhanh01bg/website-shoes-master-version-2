...
<body>
    ...
    <div class="all-product">
        <div class="simplebar-content">
            <div class="title-simplebar">
                <span>Giày nữ (<span id="quantity-all-product"></span>)</span>
            </div>
            <div class="line"></div>
            <div class="shoe-type">
                <span>Lifestyle</span>
            ...
            <div class="gender">
                ...
                <div class="check-box">
                    ...
                    <div class="female">
                        <input type="checkbox" value="Nữ" name="female" checked>
            ...
            <div class="gender">
                ...
                <div class="check-box">
                    <div class="male">
                        <input type="text" name="begin-price" value="0" checked>
                    </div>
                    <div class="female">
                        <input type="text" name="end-price" value="2000000">
                    </div>
                </div>
            </div>
            <div class="line" style="margin-top:20px;"></div>
            <div class="btn-filter" style="margin-top:50px;">
            ...
            <div class="special-product" id="nike-product">
                ...
                <div class="contain-product-item" id="container-content-product-nike-0">
                    ...
                    <div class="merchandise-item">
                        ...
                        <div class="merchandise-infos">
                            <div class="merchandise-img">
                                <img src="image/product/150c1a8e24d3ea8db3c2.jpg" alt="" onclick="redirectDetails()">
                            </div>
                            <div class="merchandise-info">
                                <span class="name-merchandise">
                                    jordan </span>
                    ...
                    <div class="merchandise-item">
                        ...
                        <div class="merchandise-infos">
                            <div class="merchandise-img">
                                <img src="image/product/2acd824fbc12724c2b03.jpg" alt="" onclick="redirectDetails()">
                            </div>
                            <div class="merchandise-info">
                                <span class="name-merchandise">
                                    jordan </span>
                    ...
                    <div class="merchandise-item">
                        ...
                        <div class="merchandise-infos">
                            <div class="merchandise-img">
                                <img src="image/product/0df23f9801c5cf9b96d4.jpg" alt="" onclick="redirectDetails()">
                            </div>
                            <div class="merchandise-info">
                                <span class="name-merchandise">
                                    jordan </span>
    ...
    <script src="script/nu.js"></script>
