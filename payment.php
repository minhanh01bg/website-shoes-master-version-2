            ...
            <div class="container-product-item" id="container-product-item">
                <div class="name-and-address">
                    ...
                    <div class="form-name">
                        ...
                        <div class="form-postal">
                            <input type="text" placeholder="Mã bưu điện"
                                class="form-postal-info">
                            <input type="text" placeholder="Thành phố"
                                class="form-postal-info">
                        </div>
                        <input type="text" placeholder="Tỉnh/Thành phố"
                            class="form-control">
                        <input type="text" placeholder="Việt nam" readonly
                            class="form-control">
                    </div>
                    <div class="title-content">
                    ...
                    <div class="form-credit-payment">
                        <input type="text" placeholder="Thẻ tín dụng hoặc thẻ
                            ghi nợ" readonly class="form-control">
