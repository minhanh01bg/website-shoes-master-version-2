...
<body>
  ...
  <div class="all-product">
    <div class="simplebar-content">
      <div class="title-simplebar">
        <span>Giày nam (<span id="quantity-all-product"></span>)</span>
      </div>
      <div class="line"></div>
      <div class="shoe-type">
        <span>Lifestyle</span>
      ...
      <div class="gender">
        ...
        <div class="check-box">
          <div class="male">
            <input type="checkbox" name="male" value="Nam" checked>
      ...
      <div class="gender">
        ...
        <div class="check-box">
          <div class="male">
            <input type="text" name="begin-price" value="0" id="begin-price" required>
          </div>
          <div class="female">
            <input type="text" name="end-price" value="2000000" id="end-price" required>
          </div>
        </div>
      </div>
      <div class="line" style="margin-top:20px;"></div>
      <div class="btn-filter" style="margin-top:50px;">
        <span onclick="filter()">Lọc sản phẩm</span>
      </div>
    </div>
  ...
  <script src="script/nam.js"></script>
